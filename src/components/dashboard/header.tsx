      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          <input
            ...
            className="w-full max-w-xs rounded-lg border bg-white py-2 pl-10 pr-4 text-sm shadow-md transition-colors focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        ...
        <div className="relative">
          <select
            ...
            className="w-full max-w-xs appearance-none rounded-lg border bg-white py-2 pl-4 pr-10 text-sm shadow-md transition-colors focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
          >
